...
def main() -> None:
    ...
    parser.add_argument(
        "--mode", choices=("zero", "engineering", "learned"), required=True
    )
    ...
    try:
        ...
        if args.mode in ("engineering", "learned"):
            policy = (
        ...
        write_json_once(
            receipt_path,
            {
                ...
                "engineering_policy_calls": (
                    call_index if args.mode == "engineering" else 0
                ),
