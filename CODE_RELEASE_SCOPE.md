...
- Result-independent unit tests and engineering-delta audits.
- Deterministic source-manifest and verification utilities.

## Excluded

- Manuscript, figures, tables, highlights and submission documents.
- Aggregate analysis, raw trajectories and cross-benchmark result files.
- Formal receipts, remote snapshots, process logs and server paths beyond
...
The research files were copied without modifying their scientific logic. This
public assembly does not change tasks, policies, seeds, contracts, thresholds,
